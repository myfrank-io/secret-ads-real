...
const SEED_CAMPAIGNS: Campaign[] = [
  {
    id: "cmp_vercel",
    name: "Vercel — Ship AI apps",
    advertiser: "Vercel",
    topic: "devtools",
    targets: ["claude-code", "cursor", "claude", "chatgpt"],
    status: "active",
    budget: 18000,
    cpc: 1.4,
    headline: "Votre app Next.js en prod pendant que l'IA finit sa phrase",
    body: "Deploy previews sur chaque push, zéro config. Hobby gratuit.",
    cta: "Déployer",
    url: "https://vercel.com",
    color: "#3987e5",
    createdAt: dateNDaysAgo(28),
  },
  {
    id: "cmp_sentry",
    name: "Sentry — Errors happen",
    advertiser: "Sentry",
    topic: "devtools",
    ...
    budget: 14000,
    cpc: 1.6,
    headline: "Le code généré par l'IA casse aussi. Sachez-le avant vos users",
    body: "Monitoring d'erreurs et de performance, setup en 5 minutes.",
    cta: "Installer Sentry",
    url: "https://sentry.io",
    color: "#d95926",
    createdAt: dateNDaysAgo(21),
  },
  {
    id: "cmp_scaleway",
    name: "Scaleway — GPU européens",
    advertiser: "Scaleway",
    topic: "cloud",
    targets: ["claude-code", "cursor", "mistral"],
    status: "active",
    budget: 20000,
    cpc: 1.8,
    headline: "Vos inférences IA sur GPU européens, facturées à la seconde",
    body: "H100 dès maintenant, données hébergées en France.",
    cta: "Lancer une instance",
    url: "https://www.scaleway.com",
    color: "#9085e9",
    createdAt: dateNDaysAgo(17),
  },
  {
    id: "cmp_notion",
